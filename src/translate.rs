...
pub fn literal_unsigned_int(n: u64) -> Expr {
    Expr::Int(i64::from_le_bytes(n.to_le_bytes()))
}

pub fn literal_float(n: f64) -> Expr {
    Expr::Float(n)
}
...
pub fn binop(binop: BinOp, lhs: ExprInfo, rhs: ExprInfo) -> Expr {
    let binop = match binop {
        ...
        BinOp::LShift if lhs.ty == Type::Int => IRBinOp::LShift,
        BinOp::RShift if lhs.ty == Type::Int => IRBinOp::RShift,
        BinOp::LShift => IRBinOp::LogicalLShift,
        BinOp::RShift => IRBinOp::LogicalRShift,
